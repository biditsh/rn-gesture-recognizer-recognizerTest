...
import { line_du, line_ud, carat_ck, carat_ack, circle_ck, circle_ack, arch_ck, arch_ack, alphabet_R } from './trainData.js'
...
let gestureRecognizer = class{
	constructor(data){
		if (data) {
			if (data.classNames) {
				...
				// this.addGesture("line", line_du);
				// this.addGesture("carat", carat_ck);
				// this.addGesture("circle", circle_ck, 1);
				// this.addGesture("arch", arch_ck);		
				// this.addGesture("line", line_ud);
				// this.addGesture("carat", carat_ack);
				// this.addGesture("circle", circle_ack,1);
				// this.addGesture("arch", arch_ack);
				// this.addGesture("R", alphabet_R);
				this.train();
				}
			}
	}
	...
	train(){
		...
		console.log("weight 0 ::: ", this._weight0sofAllVectors)
	...
	addGesture(className, gestureClass, symmetrical=0){
	...
	classifyGesture(points){
		...
		console.log("Rubine ::: ", this._classNames[maxIndex])
